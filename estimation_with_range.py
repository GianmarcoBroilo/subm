...
link_ends_jupiter = dict()
link_ends_jupiter[observation.receiver] = ("Earth", "")
link_ends_jupiter[observation.transmitter] = ("Jupiter", "")
...
bias_range = observation.absolute_bias(np.array([0.25]))

# Create observation settings for each link/observable
observation_settings_list_io = observation.angular_position(link_ends_io,bias_settings = bias_io)
observation_settings_list_jup = observation.angular_position(link_ends_jupiter,bias_settings = bias_jup)
observation_settings_list_range = observation.one_way_range(link_ends_jupiter, bias_settings = bias_range)
...
observation_times_io = np.arange(simulation_start_epoch,simulation_end_epoch,14*constants.JULIAN_DAY)
...
observation_simulation_settings_jup_range = observation.tabulated_simulation_settings(
...
observation_simulation_settings.append(observation_simulation_settings_jup_range)
